...
export default function AdminPage() {
  ...
  const [vistaActiva, setVistaActiva] = useState<"detallados" | "validacion" | "pdf">("detallados");
  ...
  return (
    <main className="min-h-screen bg-slate-50 py-10 px-4">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="border-l border-slate-200 pl-4 h-10 flex flex-col justify-center">
              ...
              <p className="text-xs text-slate-500 mt-1">
                {vistaActiva === "detallados"
                  ...
                  : "Buscar proveedor y generar ficha en PDF"
                }
              </p>
            </div>
          </div>
        ...
        {/* Pestañas de Vista */}
        <div className="print:hidden flex border-b border-slate-200 mb-6 gap-2">
          <button
        ...
        {vistaActiva === "pdf" && <GenerarPDF />}

        {/* Tabla Condicional */}
        {vistaActiva === "pdf" ? null : vistaActiva === "detallados" ? (
